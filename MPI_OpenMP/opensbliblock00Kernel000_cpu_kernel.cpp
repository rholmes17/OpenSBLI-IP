...
void ops_par_loop_opensbliblock00Kernel000_execute(ops_kernel_descriptor *desc) {
  ...
  if (OPS_diags > 1) {
    ops_timing_realloc(13,"opensbliblock00Kernel000");
    OPS_kernels[13].count++;
    ops_timers_core(&__c2,&__t2);
  }

  #ifdef OPS_DEBUG
  ops_register_args(args, "opensbliblock00Kernel000");
  #endif
  ...
  if (OPS_diags > 1) {
    ...
    OPS_kernels[13].mpi_time += __t1-__t2;
  }
  ...
  for ( int n_z=start[2]; n_z<end[2]; n_z++ ){
    for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
      ...
      for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
        ACC<double> Residual4_B0(xdim0_opensbliblock00Kernel000, ydim0_opensbliblock00Kernel000, Residual4_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel000*1 + n_z * xdim0_opensbliblock00Kernel000 * ydim0_opensbliblock00Kernel000*1);
        ACC<double> Residual3_B0(xdim1_opensbliblock00Kernel000, ydim1_opensbliblock00Kernel000, Residual3_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel000*1 + n_z * xdim1_opensbliblock00Kernel000 * ydim1_opensbliblock00Kernel000*1);
        ACC<double> Residual0_B0(xdim2_opensbliblock00Kernel000, ydim2_opensbliblock00Kernel000, Residual0_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel000*1 + n_z * xdim2_opensbliblock00Kernel000 * ydim2_opensbliblock00Kernel000*1);
        ACC<double> Residual2_B0(xdim3_opensbliblock00Kernel000, ydim3_opensbliblock00Kernel000, Residual2_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel000*1 + n_z * xdim3_opensbliblock00Kernel000 * ydim3_opensbliblock00Kernel000*1);
        ACC<double> Residual1_B0(xdim4_opensbliblock00Kernel000, ydim4_opensbliblock00Kernel000, Residual1_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel000*1 + n_z * xdim4_opensbliblock00Kernel000 * ydim4_opensbliblock00Kernel000*1);
