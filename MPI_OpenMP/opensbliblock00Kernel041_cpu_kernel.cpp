...
void ops_par_loop_opensbliblock00Kernel041_execute(ops_kernel_descriptor *desc) {
  ...
  #ifdef OPS_DEBUG
  ops_register_args(args, "opensbliblock00Kernel041");
  #endif
  ...
  int ydim2_opensbliblock00Kernel041 = args[2].dat->size[1];
  ...
  for ( int n_z=start[2]; n_z<end[2]; n_z++ ){
    for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
      ...
      for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
        ...
        const ACC<double> rhou2_B0(xdim1_opensbliblock00Kernel041, ydim1_opensbliblock00Kernel041, rhou2_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel041*1 + n_z * xdim1_opensbliblock00Kernel041 * ydim1_opensbliblock00Kernel041*1);
        ACC<double> u2_B0(xdim2_opensbliblock00Kernel041, ydim2_opensbliblock00Kernel041, u2_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel041*1 + n_z * xdim2_opensbliblock00Kernel041 * ydim2_opensbliblock00Kernel041*1);
