...
void ops_par_loop_opensbliblock00Kernel080_execute(ops_kernel_descriptor *desc) {
  ...
  #ifdef OPS_DEBUG
  ops_register_args(args, "opensbliblock00Kernel080");
  #endif
  ...
  for ( int n_z=start[2]; n_z<end[2]; n_z++ ){
    for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
      ...
      for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
        const ACC<double> rho_B0(xdim0_opensbliblock00Kernel080, ydim0_opensbliblock00Kernel080, rho_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel080*1 + n_z * xdim0_opensbliblock00Kernel080 * ydim0_opensbliblock00Kernel080*1);
        const ACC<double> p_B0(xdim1_opensbliblock00Kernel080, ydim1_opensbliblock00Kernel080, p_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel080*1 + n_z * xdim1_opensbliblock00Kernel080 * ydim1_opensbliblock00Kernel080*1);
        ACC<double> T_B0(xdim2_opensbliblock00Kernel080, ydim2_opensbliblock00Kernel080, T_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel080*1 + n_z * xdim2_opensbliblock00Kernel080 * ydim2_opensbliblock00Kernel080*1);
