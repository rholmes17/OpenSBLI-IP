...
void opensbliblock00Kernel004(const ptr_double wk39_B0,
  ptr_double wk0_B0)
{
    OPS_ACC(wk0_B0, 0,0,0) = inv_0*(-rc21*OPS_ACC(wk39_B0, 2,0,0) + (rc22)*OPS_ACC(wk39_B0, 3,0,0) -
      rc23*OPS_ACC(wk39_B0, 4,0,0) + (rc23)*OPS_ACC(wk39_B0, -4,0,0) - rc24*OPS_ACC(wk39_B0, -1,0,0) -
      rc22*OPS_ACC(wk39_B0, -3,0,0) + (rc24)*OPS_ACC(wk39_B0, 1,0,0) + (rc21)*OPS_ACC(wk39_B0, -2,0,0));
