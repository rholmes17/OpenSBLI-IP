...
int iteration_range_88_block0[] = {-4, block0np0 + 4, -4, block0np1 + 4, -4, block0np2 + 4}; ops_par_loop_opensbliblock00Kernel088("Grid_based_initialisation0", opensbliblock00, 3, iteration_range_88_block0,
...
{
int iteration_range_82_block0[] = {0, 1, -4, block0np1 + 4, -4, block0np2 + 4}; ops_par_loop_opensbliblock00Kernel082("Symmetry boundary dir0 side0", opensbliblock00, 3, iteration_range_82_block0,
...
int iteration_range_83_block0[] = {block0np0 - 1, block0np0, -4, block0np1 + 4, -4, block0np2 + 4}; ops_par_loop_opensbliblock00Kernel083("Symmetry boundary dir0 side1", opensbliblock00, 3, iteration_range_83_block0,
             ops_arg_dat(rhoE_B0, 1, stencil_0_01, "double", OPS_RW),
             ops_arg_dat(rhou1_B0, 1, stencil_0_01, "double", OPS_RW),
             ops_arg_dat(rhou0_B0, 1, stencil_0_01, "double", OPS_RW),
             ops_arg_dat(rho_B0, 1, stencil_0_01, "double", OPS_RW),
...
int iteration_range_84_block0[] = {-4, block0np0 + 4, 0, 1, -4, block0np2 + 4}; ops_par_loop_opensbliblock00Kernel084("Symmetry boundary dir1 side0", opensbliblock00, 3, iteration_range_84_block0,
...
int iteration_range_85_block0[] = {-4, block0np0 + 4, block0np1 - 1, block0np1, -4, block0np2 + 4}; ops_par_loop_opensbliblock00Kernel085("Symmetry boundary dir1 side1", opensbliblock00, 3, iteration_range_85_block0,
             ops_arg_dat(rhoE_B0, 1, stencil_0_02, "double", OPS_RW),
             ops_arg_dat(rhou1_B0, 1, stencil_0_02, "double", OPS_RW),
             ops_arg_dat(rhou0_B0, 1, stencil_0_02, "double", OPS_RW),
             ops_arg_dat(rho_B0, 1, stencil_0_02, "double", OPS_RW),
...
int iteration_range_86_block0[] = {-4, block0np0 + 4, -4, block0np1 + 4, 0, 1}; ops_par_loop_opensbliblock00Kernel086("Symmetry boundary dir2 side0", opensbliblock00, 3, iteration_range_86_block0,
...
int iteration_range_87_block0[] = {-4, block0np0 + 4, -4, block0np1 + 4, block0np2 - 1, block0np2}; ops_par_loop_opensbliblock00Kernel087("Symmetry boundary dir2 side1", opensbliblock00, 3, iteration_range_87_block0,
             ops_arg_dat(rhoE_B0, 1, stencil_0_03, "double", OPS_RW),
             ops_arg_dat(rhou1_B0, 1, stencil_0_03, "double", OPS_RW),
             ops_arg_dat(rhou0_B0, 1, stencil_0_03, "double", OPS_RW),
             ops_arg_dat(rho_B0, 1, stencil_0_03, "double", OPS_RW),
...
{
int iteration_range_41_block0[] = {-4, block0np0 + 4, -4, block0np1 + 4, -4, block0np2 + 4}; ops_par_loop_opensbliblock00Kernel041("CRu2_B0", opensbliblock00, 3, iteration_range_41_block0,
             ops_arg_dat(rho_B0, 1, stencil_0_00, "double", OPS_READ),
             ops_arg_dat(rhou2_B0, 1, stencil_0_00, "double", OPS_READ),
             ops_arg_dat(u2_B0, 1, stencil_0_00, "double", OPS_WRITE));

int iteration_range_3_block0[] = {-4, block0np0 + 4, -4, block0np1 + 4, -4, block0np2 + 4}; ops_par_loop_opensbliblock00Kernel003("CRu0_B0", opensbliblock00, 3, iteration_range_3_block0,
             ops_arg_dat(rhou0_B0, 1, stencil_0_00, "double", OPS_READ),
             ops_arg_dat(rho_B0, 1, stencil_0_00, "double", OPS_READ),
             ops_arg_dat(u0_B0, 1, stencil_0_00, "double", OPS_WRITE));

int iteration_range_23_block0[] = {-4, block0np0 + 4, -4, block0np1 + 4, -4, block0np2 + 4}; ops_par_loop_opensbliblock00Kernel023("CRu1_B0", opensbliblock00, 3, iteration_range_23_block0,
             ops_arg_dat(rhou1_B0, 1, stencil_0_00, "double", OPS_READ),
             ops_arg_dat(rho_B0, 1, stencil_0_00, "double", OPS_READ),
             ops_arg_dat(u1_B0, 1, stencil_0_00, "double", OPS_WRITE));

int iteration_range_7_block0[] = {-4, block0np0 + 4, -4, block0np1 + 4, -4, block0np2 + 4}; ops_par_loop_opensbliblock00Kernel007("CRp_B0", opensbliblock00, 3, iteration_range_7_block0,
             ops_arg_dat(rhoE_B0, 1, stencil_0_00, "double", OPS_READ),
             ops_arg_dat(rho_B0, 1, stencil_0_00, "double", OPS_READ),
...
int iteration_range_80_block0[] = {-4, block0np0 + 4, -4, block0np1 + 4, -4, block0np2 + 4}; ops_par_loop_opensbliblock00Kernel080("CRT_B0", opensbliblock00, 3, iteration_range_80_block0,
             ops_arg_dat(rho_B0, 1, stencil_0_00, "double", OPS_READ),
...
int iteration_range_1_block0[] = {-4, block0np0 + 4, 0, block0np1, 0, block0np2}; ops_par_loop_opensbliblock00Kernel001("Convective terms group 0", opensbliblock00, 3, iteration_range_1_block0,
             ops_arg_dat(rhou2_B0, 1, stencil_0_00, "double", OPS_READ),
             ops_arg_dat(rhoE_B0, 1, stencil_0_00, "double", OPS_READ),
             ops_arg_dat(rho_B0, 1, stencil_0_00, "double", OPS_READ),
             ops_arg_dat(p_B0, 1, stencil_0_00, "double", OPS_READ),
...
int iteration_range_22_block0[] = {0, block0np0, -4, block0np1 + 4, 0, block0np2}; ops_par_loop_opensbliblock00Kernel022("Convective terms group 1", opensbliblock00, 3, iteration_range_22_block0,
             ops_arg_dat(rhoE_B0, 1, stencil_0_00, "double", OPS_READ),
             ops_arg_dat(rho_B0, 1, stencil_0_00, "double", OPS_READ),
             ops_arg_dat(p_B0, 1, stencil_0_00, "double", OPS_READ),
             ops_arg_dat(rhou1_B0, 1, stencil_0_00, "double", OPS_READ),
...
int iteration_range_37_block0[] = {0, block0np0, 0, block0np1, -4, block0np2 + 4}; ops_par_loop_opensbliblock00Kernel037("Convective terms group 2", opensbliblock00, 3, iteration_range_37_block0,
             ops_arg_dat(u2_B0, 1, stencil_0_00, "double", OPS_READ),
             ops_arg_dat(rhoE_B0, 1, stencil_0_00, "double", OPS_READ),
             ops_arg_dat(rho_B0, 1, stencil_0_00, "double", OPS_READ),
             ops_arg_dat(p_B0, 1, stencil_0_00, "double", OPS_READ),
...
int iteration_range_55_block0[] = {0, block0np0, 0, block0np1, -4, block0np2 + 4}; ops_par_loop_opensbliblock00Kernel055("Viscous CD u1_B0 x1 ", opensbliblock00, 3, iteration_range_55_block0,
             ops_arg_dat(u1_B0, 1, stencil_0_02, "double", OPS_READ),
             ops_arg_dat(wk2_B0, 1, stencil_0_00, "double", OPS_WRITE));
...
int iteration_range_59_block0[] = {0, block0np0, 0, block0np1, -4, block0np2 + 4}; ops_par_loop_opensbliblock00Kernel059("Viscous CD u2_B0 x0 ", opensbliblock00, 3, iteration_range_59_block0,
...
int iteration_range_63_block0[] = {0, block0np0, 0, block0np1, -4, block0np2 + 4}; ops_par_loop_opensbliblock00Kernel063("Viscous CD u2_B0 x1 ", opensbliblock00, 3, iteration_range_63_block0,
...
int iteration_range_66_block0[] = {0, block0np0, -4, block0np1 + 4, -4, block0np2 + 4}; ops_par_loop_opensbliblock00Kernel066("Viscous CD u0_B0 x0 ", opensbliblock00, 3, iteration_range_66_block0,
             ops_arg_dat(u0_B0, 1, stencil_0_01, "double", OPS_READ),
             ops_arg_dat(wk13_B0, 1, stencil_0_00, "double", OPS_WRITE));
...
int iteration_range_68_block0[] = {0, block0np0, -4, block0np1 + 4, 0, block0np2}; ops_par_loop_opensbliblock00Kernel068("Viscous CD u1_B0 x0 ", opensbliblock00, 3, iteration_range_68_block0,
