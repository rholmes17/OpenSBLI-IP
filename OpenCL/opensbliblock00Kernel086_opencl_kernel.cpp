...
void buildOpenCLKernels_opensbliblock00Kernel086(int xdim0, int ydim0, int xdim1, int ydim1, int xdim2, int ydim2, int xdim3, int ydim3, int xdim4, int ydim4) {
  ...
  if(!isbuilt_opensbliblock00Kernel086) {
    ...
    printf("Compiling opensbliblock00Kernel086 %d source -- start \n",OCL_FMA);
      ...
      printf("compiling opensbliblock00Kernel086 -- done\n");

    // Create the OpenCL kernel
    OPS_opencl_core.kernel[5] = clCreateKernel(OPS_opencl_core.program, "ops_opensbliblock00Kernel086", &ret);
    clSafeCall( ret );
...
void ops_par_loop_opensbliblock00Kernel086(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4) {
  ...
  if (OPS_diags > 1) {
    ops_timing_realloc(5,"opensbliblock00Kernel086");
    OPS_kernels[5].count++;
  ...
  buildOpenCLKernels_opensbliblock00Kernel086(
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[5], 5, sizeof(cl_int), (void*) &base0 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[5], 6, sizeof(cl_int), (void*) &base1 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[5], 7, sizeof(cl_int), (void*) &base2 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[5], 8, sizeof(cl_int), (void*) &base3 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[5], 9, sizeof(cl_int), (void*) &base4 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[5], 10, sizeof(cl_int), (void*) &x_size ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[5], 11, sizeof(cl_int), (void*) &y_size ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[5], 12, sizeof(cl_int), (void*) &z_size ));
