...
void buildOpenCLKernels_opensbliblock00Kernel080(int xdim0, int ydim0, int xdim1, int ydim1, int xdim2, int ydim2) {
  ...
  if(!isbuilt_opensbliblock00Kernel080) {
    ...
    printf("Compiling opensbliblock00Kernel080 %d source -- start \n",OCL_FMA);
      ...
      printf("compiling opensbliblock00Kernel080 -- done\n");

    // Create the OpenCL kernel
    OPS_opencl_core.kernel[12] = clCreateKernel(OPS_opencl_core.program, "ops_opensbliblock00Kernel080", &ret);
    clSafeCall( ret );
...
void ops_par_loop_opensbliblock00Kernel080(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  if (OPS_diags > 1) {
    ops_timing_realloc(12,"opensbliblock00Kernel080");
  ...
  buildOpenCLKernels_opensbliblock00Kernel080(
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[12], 3, sizeof(cl_double), (void*) &Minf ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[12], 4, sizeof(cl_double), (void*) &gama ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[12], 5, sizeof(cl_int), (void*) &base0 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[12], 6, sizeof(cl_int), (void*) &base1 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[12], 7, sizeof(cl_int), (void*) &base2 ));
    ...
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[12], 10, sizeof(cl_int), (void*) &z_size ));
