...
void buildOpenCLKernels_opensbliblock00Kernel084(int xdim0, int ydim0, int xdim1, int ydim1, int xdim2, int ydim2, int xdim3, int ydim3, int xdim4, int ydim4) {
  ...
  if(!isbuilt_opensbliblock00Kernel084) {
    ...
    printf("Compiling opensbliblock00Kernel084 %d source -- start \n",OCL_FMA);
      ...
      printf("compiling opensbliblock00Kernel084 -- done\n");

    // Create the OpenCL kernel
    OPS_opencl_core.kernel[3] = clCreateKernel(OPS_opencl_core.program, "ops_opensbliblock00Kernel084", &ret);
    clSafeCall( ret );
...
void ops_par_loop_opensbliblock00Kernel084(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4) {
  ...
  buildOpenCLKernels_opensbliblock00Kernel084(
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[3], 4, sizeof(cl_mem), (void*) &arg4.data_d ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[3], 5, sizeof(cl_int), (void*) &base0 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[3], 6, sizeof(cl_int), (void*) &base1 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[3], 7, sizeof(cl_int), (void*) &base2 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[3], 8, sizeof(cl_int), (void*) &base3 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[3], 9, sizeof(cl_int), (void*) &base4 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[3], 10, sizeof(cl_int), (void*) &x_size ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[3], 11, sizeof(cl_int), (void*) &y_size ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[3], 12, sizeof(cl_int), (void*) &z_size ));
