...
void ops_par_loop_opensbliblock00Kernel073(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1) {
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[73], 3, sizeof(cl_double), (void*) &rc21 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[73], 4, sizeof(cl_double), (void*) &rc25 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[73], 5, sizeof(cl_double), (void*) &rc26 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[73], 6, sizeof(cl_double), (void*) &rc27 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[73], 7, sizeof(cl_double), (void*) &rc28 ));
    ...
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[73], 12, sizeof(cl_int), (void*) &z_size ));
