...
void buildOpenCLKernels_opensbliblock00Kernel001(int xdim0, int ydim0, int xdim1, int ydim1, int xdim2, int ydim2, int xdim3, int ydim3, int xdim4, int ydim4, int xdim5, int ydim5, int xdim6, int ydim6, int xdim7, int ydim7, int xdim8, int ydim8, int xdim9, int ydim9, int xdim10, int ydim10, int xdim11, int ydim11, int xdim12, int ydim12) {
  ...
  if(!isbuilt_opensbliblock00Kernel001) {
    ...
    printf("Compiling opensbliblock00Kernel001 %d source -- start \n",OCL_FMA);
      ...
      printf("compiling opensbliblock00Kernel001 -- done\n");

    // Create the OpenCL kernel
    OPS_opencl_core.kernel[14] = clCreateKernel(OPS_opencl_core.program, "ops_opensbliblock00Kernel001", &ret);
    clSafeCall( ret );
...
void ops_par_loop_opensbliblock00Kernel001(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg9, ops_arg arg10, ops_arg arg11, ops_arg arg12) {
  ...
  buildOpenCLKernels_opensbliblock00Kernel001(
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[14], 11, sizeof(cl_mem), (void*) &arg11.data_d ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[14], 12, sizeof(cl_mem), (void*) &arg12.data_d ));
    ...
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[14], 16, sizeof(cl_int), (void*) &base3 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[14], 17, sizeof(cl_int), (void*) &base4 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[14], 18, sizeof(cl_int), (void*) &base5 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[14], 19, sizeof(cl_int), (void*) &base6 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[14], 20, sizeof(cl_int), (void*) &base7 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[14], 21, sizeof(cl_int), (void*) &base8 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[14], 22, sizeof(cl_int), (void*) &base9 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[14], 23, sizeof(cl_int), (void*) &base10 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[14], 24, sizeof(cl_int), (void*) &base11 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[14], 25, sizeof(cl_int), (void*) &base12 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[14], 26, sizeof(cl_int), (void*) &x_size ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[14], 27, sizeof(cl_int), (void*) &y_size ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[14], 28, sizeof(cl_int), (void*) &z_size ));
