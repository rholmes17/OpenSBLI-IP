...
void opensbliblock00Kernel073(const ptr_double u1_B0,
  ptr_double wk20_B0, const double inv_4, const double rc21, const double rc25, const double rc26, const double rc27, const double rc28)
{
    OPS_ACCS(wk20_B0, 0,0,0) = inv_4*((rc25)*OPS_ACCS(u1_B0, 0,-1,0) - rc26*OPS_ACCS(u1_B0, 0,0,0) +
      (rc27)*OPS_ACCS(u1_B0, 0,3,0) + (rc25)*OPS_ACCS(u1_B0, 0,1,0) - rc21*OPS_ACCS(u1_B0, 0,-2,0) -
      rc28*OPS_ACCS(u1_B0, 0,4,0) - rc28*OPS_ACCS(u1_B0, 0,-4,0) - rc21*OPS_ACCS(u1_B0, 0,2,0) +
      (rc27)*OPS_ACCS(u1_B0, 0,-3,0));
