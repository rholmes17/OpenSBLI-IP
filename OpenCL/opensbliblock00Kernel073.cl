...
void opensbliblock00Kernel073(const ptr_double u1_B0,
  ptr_double wk20_B0, const double inv_4, const double rc8, const double rc13, const double rc14)
{
    OPS_ACCS(wk20_B0, 0,0,0) = inv_4*(-rc13*OPS_ACCS(u1_B0, 0,-2,0) + (rc8)*OPS_ACCS(u1_B0, 0,-1,0) +
      (rc8)*OPS_ACCS(u1_B0, 0,1,0) - rc13*OPS_ACCS(u1_B0, 0,2,0) - rc14*OPS_ACCS(u1_B0, 0,0,0));
