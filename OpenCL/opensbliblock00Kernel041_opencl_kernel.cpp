...
void buildOpenCLKernels_opensbliblock00Kernel041(int xdim0, int ydim0, int xdim1, int ydim1, int xdim2, int ydim2) {
  ...
  if(!isbuilt_opensbliblock00Kernel041) {
    ...
    printf("Compiling opensbliblock00Kernel041 %d source -- start \n",OCL_FMA);
      ...
      if (pPath!=NULL)
        if(OCL_FMA)
          sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/c/include -DOPS_WARPSIZE=%d  -Dxdim0_opensbliblock00Kernel041=%d  -Dydim0_opensbliblock00Kernel041=%d  -Dxdim1_opensbliblock00Kernel041=%d  -Dydim1_opensbliblock00Kernel041=%d  -Dxdim2_opensbliblock00Kernel041=%d  -Dydim2_opensbliblock00Kernel041=%d ", pPath, 32,xdim0,ydim0,xdim1,ydim1,xdim2,ydim2);
        else
      ...
      printf("compiling opensbliblock00Kernel041 -- done\n");

    // Create the OpenCL kernel
    OPS_opencl_core.kernel[8] = clCreateKernel(OPS_opencl_core.program, "ops_opensbliblock00Kernel041", &ret);
    clSafeCall( ret );
...
void ops_par_loop_opensbliblock00Kernel041(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  if (OPS_diags > 1) {
    ops_timing_realloc(8,"opensbliblock00Kernel041");
    OPS_kernels[8].count++;
  ...
  buildOpenCLKernels_opensbliblock00Kernel041(
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[8], 3, sizeof(cl_int), (void*) &base0 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[8], 4, sizeof(cl_int), (void*) &base1 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[8], 5, sizeof(cl_int), (void*) &base2 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[8], 6, sizeof(cl_int), (void*) &x_size ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[8], 7, sizeof(cl_int), (void*) &y_size ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[8], 8, sizeof(cl_int), (void*) &z_size ));
