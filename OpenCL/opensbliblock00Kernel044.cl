...
void opensbliblock00Kernel044(const ptr_double rhou2_B0,
  ptr_double wk31_B0, const double inv_2, const double rc21, const double rc22, const double rc23, const double rc24)
{
    OPS_ACCS(wk31_B0, 0,0,0) = inv_2*(-rc21*OPS_ACCS(rhou2_B0, 0,0,2) + (rc23)*OPS_ACCS(rhou2_B0, 0,0,-4) +
      (rc24)*OPS_ACCS(rhou2_B0, 0,0,1) - rc23*OPS_ACCS(rhou2_B0, 0,0,4) + (rc21)*OPS_ACCS(rhou2_B0, 0,0,-2) +
      (rc22)*OPS_ACCS(rhou2_B0, 0,0,3) - rc22*OPS_ACCS(rhou2_B0, 0,0,-3) - rc24*OPS_ACCS(rhou2_B0, 0,0,-1));
