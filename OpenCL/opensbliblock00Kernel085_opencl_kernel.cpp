...
void buildOpenCLKernels_opensbliblock00Kernel085(int xdim0, int ydim0, int xdim1, int ydim1, int xdim2, int ydim2, int xdim3, int ydim3, int xdim4, int ydim4) {
  ...
  if(!isbuilt_opensbliblock00Kernel085) {
    ...
    printf("Compiling opensbliblock00Kernel085 %d source -- start \n",OCL_FMA);
      ...
      if (pPath!=NULL)
        if(OCL_FMA)
          sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/c/include -DOPS_WARPSIZE=%d  -Dxdim0_opensbliblock00Kernel085=%d  -Dydim0_opensbliblock00Kernel085=%d  -Dxdim1_opensbliblock00Kernel085=%d  -Dydim1_opensbliblock00Kernel085=%d  -Dxdim2_opensbliblock00Kernel085=%d  -Dydim2_opensbliblock00Kernel085=%d  -Dxdim3_opensbliblock00Kernel085=%d  -Dydim3_opensbliblock00Kernel085=%d  -Dxdim4_opensbliblock00Kernel085=%d  -Dydim4_opensbliblock00Kernel085=%d ", pPath, 32,xdim0,ydim0,xdim1,ydim1,xdim2,ydim2,xdim3,ydim3,xdim4,ydim4);
        else
      ...
      printf("compiling opensbliblock00Kernel085 -- done\n");

    // Create the OpenCL kernel
    OPS_opencl_core.kernel[4] = clCreateKernel(OPS_opencl_core.program, "ops_opensbliblock00Kernel085", &ret);
    clSafeCall( ret );
...
void ops_par_loop_opensbliblock00Kernel085(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4) {
  ...
  buildOpenCLKernels_opensbliblock00Kernel085(
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[4], 7, sizeof(cl_int), (void*) &base2 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[4], 8, sizeof(cl_int), (void*) &base3 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[4], 9, sizeof(cl_int), (void*) &base4 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[4], 10, sizeof(cl_int), (void*) &x_size ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[4], 11, sizeof(cl_int), (void*) &y_size ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[4], 12, sizeof(cl_int), (void*) &z_size ));
