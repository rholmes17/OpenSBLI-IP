...
void buildOpenCLKernels_opensbliblock00Kernel087(int xdim0, int ydim0, int xdim1, int ydim1, int xdim2, int ydim2, int xdim3, int ydim3, int xdim4, int ydim4) {
  ...
  if(!isbuilt_opensbliblock00Kernel087) {
    ...
    printf("Compiling opensbliblock00Kernel087 %d source -- start \n",OCL_FMA);
      ...
      printf("compiling opensbliblock00Kernel087 -- done\n");

    // Create the OpenCL kernel
    OPS_opencl_core.kernel[6] = clCreateKernel(OPS_opencl_core.program, "ops_opensbliblock00Kernel087", &ret);
    clSafeCall( ret );
...
void ops_par_loop_opensbliblock00Kernel087(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4) {
  ...
  if (OPS_diags > 1) {
    ops_timing_realloc(6,"opensbliblock00Kernel087");
    OPS_kernels[6].count++;
  ...
  buildOpenCLKernels_opensbliblock00Kernel087(
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[6], 5, sizeof(cl_int), (void*) &base0 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[6], 6, sizeof(cl_int), (void*) &base1 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[6], 7, sizeof(cl_int), (void*) &base2 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[6], 8, sizeof(cl_int), (void*) &base3 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[6], 9, sizeof(cl_int), (void*) &base4 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[6], 10, sizeof(cl_int), (void*) &x_size ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[6], 11, sizeof(cl_int), (void*) &y_size ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[6], 12, sizeof(cl_int), (void*) &z_size ));
