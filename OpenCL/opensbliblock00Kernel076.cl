...
void opensbliblock00Kernel076(const ptr_double wk2_B0,
  ptr_double wk23_B0, const double inv_2, const double rc29, const double rc30, const double rc31, const double rc32, const double rc33)
{
    OPS_ACCS(wk23_B0, 0,0,0) = inv_2*((rc31)*OPS_ACCS(wk2_B0, 0,0,-4) - rc32*OPS_ACCS(wk2_B0, 0,0,-5) -
      rc29*OPS_ACCS(wk2_B0, 0,0,2) + (rc33)*OPS_ACCS(wk2_B0, 0,0,1) + (rc32)*OPS_ACCS(wk2_B0, 0,0,5) -
      rc33*OPS_ACCS(wk2_B0, 0,0,-1) - rc30*OPS_ACCS(wk2_B0, 0,0,-3) - rc31*OPS_ACCS(wk2_B0, 0,0,4) +
      (rc29)*OPS_ACCS(wk2_B0, 0,0,-2) + (rc30)*OPS_ACCS(wk2_B0, 0,0,3));
