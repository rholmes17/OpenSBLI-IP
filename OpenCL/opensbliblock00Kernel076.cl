...
void opensbliblock00Kernel076(const ptr_double wk2_B0,
  ptr_double wk23_B0, const double inv_2, const double rc12, const double rc13)
{
    OPS_ACCS(wk23_B0, 0,0,0) = inv_2*((rc12)*OPS_ACCS(wk2_B0, 0,0,1) - rc12*OPS_ACCS(wk2_B0, 0,0,-1) +
      (rc13)*OPS_ACCS(wk2_B0, 0,0,-2) - rc13*OPS_ACCS(wk2_B0, 0,0,2));
