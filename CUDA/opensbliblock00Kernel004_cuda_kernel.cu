...
void opensbliblock00Kernel004_gpu(const ACC<double> &wk39_B0,
  ACC<double> &wk0_B0)
{
...
void ops_par_loop_opensbliblock00Kernel004_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel004_h[0][0] || ydim0 != dims_opensbliblock00Kernel004_h[0][1] || xdim1 != dims_opensbliblock00Kernel004_h[1][0] || ydim1 != dims_opensbliblock00Kernel004_h[1][1]) {
    ...
    cutilSafeCall(cudaMemcpyToSymbol( dims_opensbliblock00Kernel004, dims_opensbliblock00Kernel004_h, sizeof(dims_opensbliblock00Kernel004)));
  }
  ...
  if (x_size > 0 && y_size > 0 && z_size > 0)
    ops_opensbliblock00Kernel004<<<grid, tblock >>> (  (double *)p_a[0], (double *)p_a[1],x_size, y_size, z_size);
