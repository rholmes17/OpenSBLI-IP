...
void opensbliblock00Kernel063_gpu(const ACC<double> &u2_B0,
  ACC<double> &wk10_B0)
{
...
void ops_par_loop_opensbliblock00Kernel063_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel063_h[0][0] || ydim0 != dims_opensbliblock00Kernel063_h[0][1] || xdim1 != dims_opensbliblock00Kernel063_h[1][0] || ydim1 != dims_opensbliblock00Kernel063_h[1][1]) {
    ...
    cutilSafeCall(cudaMemcpyToSymbol( dims_opensbliblock00Kernel063, dims_opensbliblock00Kernel063_h, sizeof(dims_opensbliblock00Kernel063)));
  }
