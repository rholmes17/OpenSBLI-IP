...
void opensbliblock00Kernel032_c_wrapper(
  ...
  for ( int n_z=0; n_z<z_size; n_z++ ){
    ...
    OPS_ACC(wk21_B0, 0,0,0) = inv_1*((rc32)*OPS_ACC(rhou1_B0, 0,5,0) + (rc31)*OPS_ACC(rhou1_B0, 0,-4,0) -
      rc30*OPS_ACC(rhou1_B0, 0,-3,0) + (rc33)*OPS_ACC(rhou1_B0, 0,1,0) - rc33*OPS_ACC(rhou1_B0, 0,-1,0) -
      rc29*OPS_ACC(rhou1_B0, 0,2,0) + (rc29)*OPS_ACC(rhou1_B0, 0,-2,0) + (rc30)*OPS_ACC(rhou1_B0, 0,3,0) -
      rc31*OPS_ACC(rhou1_B0, 0,4,0) - rc32*OPS_ACC(rhou1_B0, 0,-5,0));
